...
# apply.js не трогает.
# Переименования участников (новые слаги в src/content.js) сеялка проводит сама
# при старте контейнера, до создания недостающих страниц, — иначе она заняла бы
# новые слаги пустыми страницами, а старые — с фамилиями в названии — остались
# бы в живой вики. Отдельного шага здесь не нужно.
